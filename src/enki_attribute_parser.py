...
attributes = ["/home/levi/rhel-8-docs/rhel-8/common-content/_attributes.adoc"]
...
def get_resolved_attributes_dict(attributes):
    ...
    # removes keys w/ empty strings for value
    #resolved_attributes_dict = {key:val for key, val in resolved_attributes_dict.items() if val != ''}
...
for i in resolved_attributes_dict.items():
    print(i)
